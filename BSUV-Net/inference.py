...
# Start Video Loader
# vid_loader = videoLoader(inp_path, empty_bg=cfg.BSUVNet.emtpy_bg, empty_win_len=cfg.BSUVNet.empty_win_len, empty_bg_path='/u/l/p/lparas/Desktop/quantaTracking/BSUV-Net/back.png',
